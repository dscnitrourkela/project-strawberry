  ...
  return (
    <FooterItems>
      <FooterContainer>
        <LogoColumn>
          <div>
            <Logo src={footerContent.logo.src} alt={footerContent.logo.alt} />
          </div>
          <Description>
            <BodyText>
              National Entrepreneur Summit, National Institute of Technology,
              Rourkela
            </BodyText>
          </Description>
          <SmLogos>
            <SmLogo>
              <Link
                href="https://www.facebook.com/ecellnitr"
                target="_blank"
            ...
            <SmLogo>
              <Link
                href="https://twitter.com/ECellNITR"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaTwitter />
            ...
            <SmLogo>
              <Link
                href="https://instagram.com/ecell_nitrourkela"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaInstagram />
            ...
            <SmLogo>
              <Link
                href="https://www.youtube.com/@Ecellnitrkl"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaYoutube />
      ...
      <MadeBy>
        <Link
          href="https://www.dscnitrourkela.org/"
          target="blank"
          rel="noopener noreferrer"
        >
          <Body1>Designed and Developed with 💙 by GDSC NIT Rourkela</Body1>
        </Link>
      </MadeBy>
    </FooterItems>
  )
